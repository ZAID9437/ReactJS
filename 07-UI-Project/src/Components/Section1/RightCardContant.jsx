...
const RightCardContant = (props) => {
  return (
    <div className='absolute top-0 left-0 h-full w-full p-8 flex flex-col justify-between '>
        ...
        <div>
            <p className='text-shadow-2xs text-xl leading-normal text-white mb-14'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Corporis quos obcaecati necessitatibus voluptas illum quo.</p>
